...
const sourceTitle = "# Michael Zick — Agent Orientation (Codex / AGENTS.md)";
...
const targets = [
  {
    ...
    title: "# Michael Zick — Agent Orientation (Claude Code)",
    siblingLine:
  ...
  },
  {
    ...
    title: "# Michael Zick — Agent Orientation (Gemini CLI)",
    siblingLine:
