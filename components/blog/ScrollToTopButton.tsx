...
export default function ScrollToTopButton({ targetId }: ScrollToTopButtonProps) {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 left-8 z-40 flex h-11 w-11 items-center justify-center rounded-full bg-dark-blue/30 text-white shadow-md ring-1 ring-white/20 backdrop-blur-md transition-all duration-300 hover:bg-dark-blue/45 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70 max-[1024px]:left-[35px] max-[929px]:left-[30px] min-[1440px]:left-[70px] ${
