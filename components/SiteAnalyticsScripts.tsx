...
export default function SiteAnalyticsScripts() {
  return (
    <>
      {/* Official Mixpanel embed snippet: defines a queueing stub at
          window.mixpanel synchronously, then async-loads the library, so
          init/track calls never drop. The library URL is pinned to https so
