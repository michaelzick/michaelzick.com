...
export default function NavBar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed inset-0 bg-white text-[var(--dark-blue)] z-40 flex flex-col items-end justify-center space-y-6 p-8 transform transition-transform duration-300 ${
