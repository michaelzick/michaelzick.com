...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  return (
    <section className="bg-gray-100 px-8 pb-16 pt-24 text-default-grey max-[1024px]:px-[35px] max-[929px]:px-[30px] min-[1440px]:px-[70px] md:pb-24 md:pt-28 lg:pt-36 xl:pt-40">
      <script
